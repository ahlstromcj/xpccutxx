 ...
 *
 *    This module provides msvc access to non-socket libraries and headers
 ...
 *    file, for the benefit of the poor old msvc developer.
 *
 *----------------------------------------------------------------------------*/
 ...
 *
 * For msvc, not really sure if this exists, so assume it does not.
 */
